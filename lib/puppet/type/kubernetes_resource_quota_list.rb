  ...
  newparam(:name, namevar: true) do
    desc 'Name of the resource_quota_list.'
      ...
      newproperty(:items) do
        desc "Items is a list of ResourceQuota objects. More info: http://releases.k8s.io/release-1.2/docs/design/admission_control_resource_quota.md#admissioncontrol-plugin-resourcequota"
        def insync?(is)
          PuppetX::Puppetlabs::Swagger::Utils::fuzzy_compare(is, should)
        end
      end
