...
Puppet::Type.type(:kubernetes_service_list).provide(:swagger, :parent => PuppetX::Puppetlabs::Kubernetes::Provider) do
  ...
  def create
    ...
    create_instance_of('service_list', name, build_params)
  end
  ...
  def self.list_instances
    list_instances_of('service_list')
  end
